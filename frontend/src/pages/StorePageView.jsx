...
const StorePageView = () => {
  ...
  const fetchStoreData = useCallback(async () => {
    try {
      const storeRes = await axios.get(`/seller/store-url/${storeUrl}`);
      setStore(storeRes.data);

      const productsRes = await axios.get('/products');
      const storeProducts = productsRes.data.filter(
        (p) => p.seller_id === storeRes.data.seller_id
      );
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="section-padding">
        <div
          className="bg-white rounded-2xl p-8 mb-12 border-l-4 border-[#E07A5F]"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <img
                src={
                  store.profile_image ||
                  'https://images.unsplash.com/photo-1594179131702-112ff2a880e4?w=400'
                }
            ...
            <div className="md:col-span-2">
              <h1
                className="text-4xl font-heading font-bold text-[#3D405B] mb-4"
              ...
              <div className="flex items-center text-[#5F637A] mb-6">
                ...
                <span>
                  {store.village_name}, {store.state}
                </span>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold text-[#3D405B] mb-2">
                    Farming Practices
                  </h3>
        ...
        {products.length === 0 ? (
          <p
            className="text-[#5F637A] text-center py-10"
            data-testid="no-store-products"
          >
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-baseline justify-between">
                    ...
                    <span className="text-sm text-[#8D91A8]">
                      /{product.unit}
                    </span>
                  </div>
                </div>

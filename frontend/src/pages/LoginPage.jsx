      ...
      <div className="section-padding">
        <div className="max-w-md mx-auto">
          <div className="card p-8">
            <h1 className="text-3xl font-heading font-bold text-[#3D405B] mb-2 text-center" data-testid="login-title">
              Welcome Back
            </h1>
            <p className="text-[#5F637A] text-center mb-8">Login to Gram Connect</p>
            ...
            <p className="mt-6 text-center text-sm text-[#5F637A]">
              ...
              <Link to="/register" className="text-[#E07A5F] hover:text-[#D0694E] font-semibold" data-testid="login-register-link">
                Sign up
              </Link>
            </p>
          </div>
